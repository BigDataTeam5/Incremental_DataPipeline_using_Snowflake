...
GRANT ROLE CICD_LAB_ROLE TO USER IDENTIFIER($MY_USER);
...
GRANT READ ON STAGE CICD_LAB_DEV.DATA_SECURITY.DEPLOYMENT TO ROLE CICD_LAB_ROLE;
GRANT WRITE ON STAGE CICD_LAB_DEV.DATA_SECURITY.DEPLOYMENT TO ROLE CICD_LAB_ROLE;
GRANT READ ON STAGE CICD_LAB_PROD.DATA_SECURITY.DEPLOYMENT TO ROLE CICD_LAB_ROLE;
GRANT WRITE ON STAGE CICD_LAB_PROD.DATA_SECURITY.DEPLOYMENT TO ROLE CICD_LAB_ROLE;
